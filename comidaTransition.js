...
var bulletsContainer = document.getElementsByClassName("bullets");

// Create one bullet per layer
for( var i = 0, len = k.getTotal(); i < len; i++ ) {
	//var bullet = document.createElement( 'li' );
    var bullet = bulletsContainer[0];
...
k.changed.add( function( layer, index ) {
	var bullets = document.body.querySelectorAll( '.containerTiposComida .active' );
